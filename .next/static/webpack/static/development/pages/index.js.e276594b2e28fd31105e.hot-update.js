...
var LoadingButton = function LoadingButton() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    if (isLoading) {
      data = checkIn().then(function (props) {
        setClicked(true);
        setLoading(false);
        return props.result;
      });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:5000/check-fabian');
...
//# sourceMappingURL=index.js.e276594b2e28fd31105e.hot-update.js.map