      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            checkedIn = "";
            _context.prev = 1;
            res = axios__WEBPACK_IMPORTED_MODULE_6___default.a.all([axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('http://localhost:5000/check-fabian'), axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('http://localhost:5000/check-miguel')]).then(axios__WEBPACK_IMPORTED_MODULE_6___default.a.spread(function (fabian, miguel) {
              checkIn = (Object(_babel_runtime_corejs2_helpers_esm_readOnlyError__WEBPACK_IMPORTED_MODULE_2__["default"])("checkIn"), fabian.data.Success + miguel.data.Success);
            }));
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return axios__WEBPACK_IMPORTED_MODULE_6___default.a.get('http://localhost:5000/ping');
...
//# sourceMappingURL=index.js.5581f95c6b24751068a9.hot-update.js.map