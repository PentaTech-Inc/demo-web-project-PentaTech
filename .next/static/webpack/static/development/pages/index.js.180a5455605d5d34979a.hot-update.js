      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            checkedIn = "";
            _context.prev = 1;
            res = axios__WEBPACK_IMPORTED_MODULE_5___default.a.all([axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:5000/check-fabian'), axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:5000/check-miguel')]).then(axios__WEBPACK_IMPORTED_MODULE_5___default.a.spread(function (fabian, miguel) {
              checkedIn = fabian.data.Success + miguel.data.Success;
            }));
...
//# sourceMappingURL=index.js.180a5455605d5d34979a.hot-update.js.map