...
function () {
  ...
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
    var _useState4, checkedIn, setCheckedIn, res;

    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _useState4 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(""), checkedIn = _useState4[0], setCheckedIn = _useState4[1];
            _context.prev = 1;
            res = axios__WEBPACK_IMPORTED_MODULE_5___default.a.all([axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:5000/check-fabian'), axios__WEBPACK_IMPORTED_MODULE_5___default.a.get('http://localhost:5000/check-miguel')]).then(axios__WEBPACK_IMPORTED_MODULE_5___default.a.spread(function (props) {
              props.forEach(function (element) {
                setCheckedIn(checkIn + element.data.Success);
              });
            }));
...
//# sourceMappingURL=index.js.28c2d2d55750dc0239c7.hot-update.js.map